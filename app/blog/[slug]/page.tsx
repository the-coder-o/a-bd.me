                  ...
                  <div className={cn('', blog?.blog_video_url ? 'block' : 'hidden')}>
                    {blog?.blog_video_url?.map((item: any) => (
                      <Link href={item?.url_video} target={'_blank'}>
                        <Halo strength={5} className={'flex bg-[#efefef] dark:bg-[#121212] rounded-md overflow-clip p-4 gap-4 md:gap-6 md:p-6 items-center my-8 no-underline border border-secondary'}>
