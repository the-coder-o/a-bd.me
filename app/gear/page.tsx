...
const Item = ({ title, description, image, link, sponsored }: ItemProps) => (
  <li className="flex items-center gap-4 transition-opacity">
    <a className="relative aspect-square h-[4rem] w-[4rem] min-w-[4rem] overflow-hidden rounded-xl border border-secondary bg-tertiary shadow-sm" href={link} target="_blank">
      <Image src={image} alt={title} className="h-full w-full object-cover object-center" fill />
    </a>
    <div className="flex grow items-center justify-between gap-2">
      <div className="space-y-1">
        <h3 className="line-clamp-2 font-medium leading-tight text-primary">{title}</h3>
        <p className="line-clamp-3 text-sm leading-tight text-[#b4b4b4]">{description}</p>
      </div>
      <div>
        <a className="ml-auto h-fit rounded-full bg-[#222222] px-4 py-1 text-sm" href={link} target="_blank">
          Get
        </a>
        {sponsored && <p className="mt-1 text-center text-xs text-[#6e6e6e]">Sponsored</p>}
      </div>
    </div>
  </li>
)
      ...
      <div className="flex flex-col gap-16 md:gap-24 mt-[5rem] pb-28">
        <div className="flex animate-in flex-col gap-8">
          <div>
            ...
            <p className="animate-in text-[#b4b4b4]">My toolbox.</p>
          </div>
          <p className="max-w-md animate-in text-tertiary">This is all gear I actually own and like. Using the affiliate links help support my content creation. Updated on March 2024.</p>
        </div>
        {categories.map((category, index) => (
          <section className="flex animate-in flex-col gap-8" key={index}>
            <h2 className="text-[#b4b4b4]">{category}</h2>
            <ul className="animated-list grid gap-x-6 gap-y-8 md:grid-cols-2">
              {gear.map((item, index) => {
                if (item.category === category) {
                  return <Item key={index} title={item.name} description={item.description} image={item.image} link={item.link} sponsored={item.sponsored} />
                } else {
                  return null
                }
              })}
...
const gear = [
  {
    ...
    category: 'Ergonofis',
    image: 'https://www.b-r.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmacrofactor.5500dbba.webp&w=3840&q=75',
  ...
  },
  {
    name: 'Desk Shelf',
    category: 'Ergonofis',
    image: 'https://www.b-r.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fshelf.a1400fa5.png&w=3840&q=75',
  ...
  },
  {
    ...
    category: 'Ergonofis',
    image: 'https://www.b-r.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcables.94a18813.png&w=3840&q=75',
  ...
  },
  {
    ...
    description: 'Superb quality, favorite keeb so far. Build code Y0E1F2E3C4A5A',
    image: 'https://www.b-r.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fkeeb.e47f6f14.jpeg&w=3840&q=75',
    link: 'https://amzn.to/3U9tcE9',
  },
  {
    name: 'Logitech MX Master Mouse 3S',
    category: 'Home Desk Setup',
    description: 'Ergonomic and comfortable to be used for all day use, love the scrolling!',
  ...
  },
  {
    ...
    description: 'Leather and Recycled PET Felt | Document Hideaway | Magnetic Cable Holder',
  ...
  },
  {
    ...
    description: 'Enhances immersion and focus, creates a comfortable environment',
  ...
  },
  {
    ...
    image: 'https://www.b-r.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fraycast.c3e29e66.png&w=3840&q=75',
    link: 'https://raycast.com/?via=brianruiz',
  },
  {
    name: 'Epidemic Sound',
    category: 'Apps',
    image: 'https://www.b-r.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fepidemic-sound.41fbac20.png&w=3840&q=75',
    description: '1 Month Free. This is where I get 95% of the music for my videos. Skip the hassle that is licensing.',
  ...
  },
  {
    ...
    category: 'Apps',
    image: 'https://www.b-r.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsuperhuman.9e3c1736.png&w=3840&q=75',
  ...
  },
  {
    name: 'Copilot Money',
    category: 'Apps',
    image: 'https://www.b-r.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcopilot.344ca9ba.jpeg&w=3840&q=75',
    description: "'BRIANRUIZ', 2 months FREE. For all things personal finance, this is a must.",
  ...
  },
  {
    ...
    category: 'Camera Setup (Video)',
    description: 'Necessary for FX3 at base ISO, control exposure, and motion blur.',
  ...
  },
  {
    ...
    category: 'Camera Setup (Video)',
    description: 'Subtly Softens image. Reduces highlights and contrast, great for skin.',
    image: 'https://m.media-amazon.com/images/I/51uqnCKf2WL.__AC_SY300_SX300_QL70_FMwebp_.jpg',
  ...
  },
  {
    ...
    image: 'https://m.media-amazon.com/images/I/61Y1P6uIRFL.__AC_SX300_SY300_QL70_FMwebp_.jpg',
  ...
  },
  {
    ...
    category: 'Other',
    description: 'Fast, reliable, and secure storage. To edit videos on the go.',
