...
const Analytics = () => {
  return (
    <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 2 * 0.2 }} className="grid grid-cols-2 gap-3 md:grid-cols-6 md:gap-4">
      ...
      <div className="col-span-2 row-span-1 space-y-2 rounded-xl border dark:border-styles light-style dark:bg-[#121212] bg-[#EFEFEF] p-6 md:col-span-3">
      ...
      <div className="order-last col-span-2 row-span-2 overflow-clip rounded-xl border dark:border-styles light-style dark:bg-[#121212] bg-[#efefef] pt-6 text-center md:order-none md:col-span-3">
