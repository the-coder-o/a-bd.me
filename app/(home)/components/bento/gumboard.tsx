...
export default function Gumroad() {
  return (
    <Link href="https://gumroad.com/brianr4" className="col-span-1 row-span-1 no-underline">
      <Card className="flex aspect-square flex-col gap-1.5">
        ...
        <p className="text-[#b4b4b4]">Gumroad</p>
...
const Logo = () => (
  <svg width="16" height="16" className="h-full w-full" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="40" height="40" rx="10" fill="#FF90E8"></rect>
    <g clipPath="url(#clip0_920_2744)">
      <path d="M22.0129 32C27.5285 32 31.9998 27.5542 31.9998 22.07C31.9998 16.5857 27.5285 12.1399 22.0129 12.1399C16.4972 12.1399 12.0259 16.5857 12.0259 22.07C12.0259 27.5542 16.4972 32 22.0129 32Z" fill="black"></path>
      <path d="M19.4355 29.9196C25.2366 29.9196 29.973 25.2387 29.973 19.4224C29.973 13.6061 25.2366 8.92513 19.4355 8.92513C13.6344 8.92513 8.89795 13.6061 8.89795 19.4224C8.89795 25.2387 13.6344 29.9196 19.4355 29.9196Z" fill="#FF90E8"></path>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
