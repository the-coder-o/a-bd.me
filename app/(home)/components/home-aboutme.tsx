...
const HomeAboutMe = () => {
  return (
    <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 4 * 0.1 }}>
      <p className={'max-w-lg'}>Hi, I&apos;m Abdul Basit, a fullStack engineer who loves building cool things with code. In addition to coding, I also make YouTube videos, where I focus on tech, creative vlogs, and personal development.</p>
      <div className={'group flex gap-3 max-md:flex-col-reverse max-md:gap-2 mt-9'}>
        <div className={'flex gap-5 max-md:gap-2'}>
          <Link target={'_blank'} href="https://www.buymeacoffee.com/abdulbacit" className={'bg-[#FFDD04] max-md:w-[170px] hover:!opacity-100 group-hover:opacity-60 font-[500] flex items-center justify-center h-[32px] rounded-[6px] text-black px-3'}>
