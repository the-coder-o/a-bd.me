      ...
      <Halo strength={6} className={'p-6'}>
        ...
        <form onSubmit={handleCreate} className={'py-3 mb-10'}>
          <div className={'flex items-center gap-2'}>
            <Input id="name" type="text" value={name} placeholder={'Your name'} onChange={(e) => setName(e.target.value)} required className={'dark:!bg-[#222222] border-style-input w-[150px]'} />
            <div className={'w-full relative'}>
              <Input id="message" value={message} placeholder={'Your message...'} onChange={(e) => setMessage(e.target.value)} required className={'dark:!bg-[#222222] border-style-input'} />
