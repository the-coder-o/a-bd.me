...
const AboutContact = () => {
  return (
    <>
      <p className="text-[#646464] dark:text-[#b4b4b4] w-32 text-secondary shrink-0 mt-[-2px]">Contact</p>
      <div className="flex flex-col gap-5  w-[525px] max-md:w-full">
        ...
        <div className="flex justify-between gap-2 flex-wrap max-md:flex-col group">
          {ContactLinkData.map((link) => (
            <Link className="flex items-center justify-between rounded-[10px] input-border-style px-[15px] py-[15px] w-[240px] border-styles max-md:w-full transition hover:!opacity-100 group-hover:opacity-50" href={link.url} target={'_blank'}>
